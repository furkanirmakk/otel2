...
import Oda2Gallery from './Oda2Gallery';


function SuitOda(props) {
    ...
    return (
        <div className='bg-bg1'>
            ...
            <div className='justify-center items-center'>
                <h1 className='flex justify-center items-center text-3xl font-bold text-womco pt-8 mb-0 pb-0'>Deluxe Suit Oda</h1>
                ...
                <div className=' grid  max-sm:grid-cols-1 max-sm:pr-11 max-sm:pl-9 max-md:grid-cols-2 max-md:pr-8 min-xl:grid-cols-4 gap-4'>
                    ...
                    <div className='grid grid-cols-2 gap-2 '>
                        ...
                        <div className='max-sm:w-6' >
                            <h1 className=' pr-3 pt-2 font-bold  text-center text-yz md'>ODA TİPİ: DELUXE SUIT  </h1><div className='w-full h-12 bg-yz shadow-lg'></div>
                        </div>
                    </div>
