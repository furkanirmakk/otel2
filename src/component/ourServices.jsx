...
function OurServices() {
    ...
    return (
        <body>
                ...
                <div className=' flex mr-10 ml-10 mb-3 mt-6 max-sm:mr-0 max-sm:ml-0  max-md:mr-0 max-md:ml-0 max-lg:mr-2 max-lg:ml-4  '>
            ...
            <div className='grid grid-cols-3 gap-4 flex justify-center items-center   m-10 mt-11 max-sm:grid-cols-1 max-sm:m-4 max-md:grid-cols-2 max-md:m-3 max-lg:m-1 gap-4'>

                <div
                    className={`relative ${isHovered1 ? 'transform scale-125 transition-transform duration-500 shadow-lg rounded-full ' : ''}`}
                    onMouseEnter={handleMouseEnter1}
                    onMouseLeave={handleMouseLeave1}
                >
                    <img className='w-full   h-auto rounded-md' src={defaultImage} alt="" />
                    <div style={textStyle}>
                        <Link to='/standartOda'>Satandart Oda</Link>
                    </div>
                </div>
                <div
                    className={`relative ${isHovered2 ? 'transform scale-125 transition-transform duration-500 shadow-lg rounded-full' : ''}`}
                    onMouseEnter={handleMouseEnter2}
                    onMouseLeave={handleMouseLeave2}
                >
                    <img className='w-full   h-auto rounded-md' src={defaultImage} alt="" />
                    <div style={textStyle}>
                    <Link to='/LuksOda'>Lüks Oda</Link>
                    </div>
                </div>
                <div
                    className={`relative ${isHovered3 ? 'transform scale-125 transition-transform duration-500 rounded-full' : ''}`}
